				...
				<div class="col-lg-6 col-12 fxt-bg-color">
					<div class="fxt-content">
						<div class="fxt-header">
							<h1><strong>BUKU TAMU </strong></h1>
							<h3>KANTOR KELURAHAN GUNUNG SAMARINDA</h3>
						</div>
						<div class="fxt-form">
							<form action="{{route('simpan-bukutamu')}}" method="post">
								{{ csrf_field() }}
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="nik" class="form-control" name="nik" placeholder="NIK" required="required">
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="alamat" class="form-control" name="alamat" placeholder="ALAMAT" required="required">
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="notelepon" class="form-control" name="notelepon" placeholder="NO TELEPON" required="required">
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="menemui" class="form-control" name="menemui" placeholder="MENEMUI" required="required">
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="keperluan" class="form-control" name="keperluan" placeholder="KEPERLUAN" required="required">
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input type="datetime-local" class="form-control" name="waktu" placeholder="waktu" required="required" min="2018-06-07 00:00">
									</div>
								</div>
								<div class="form-group">
